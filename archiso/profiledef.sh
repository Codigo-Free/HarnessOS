...
airootfs_image_tool_options=('-comp' 'zstd' '-Xcompression-level' '19' '-processors' '1')
...
file_permissions=(
    ...
    ["/usr/local/bin/harness-ai"]="0:0:755"
    ["/usr/local/bin/harness-ollama-status"]="0:0:755"
    ...
    ["/usr/local/bin/harness-keyboard"]="0:0:755"
)
